Get["models/NMSSMtower/NMSSMtower_librarylink.m"];

handle = FSNMSSMtowerOpenHandle[
    fsSettings -> {
...
spectrum    = FSNMSSMtowerCalculateSpectrum[handle];
observables = FSNMSSMtowerCalculateObservables[handle];
FSNMSSMtowerCloseHandle[handle];
