...
#ifndef NMSSMtower_TWO_SCALE_MATCHING_H
#define NMSSMtower_TWO_SCALE_MATCHING_H
...
template <class T> class NMSSMtower;
template <class T> class NMSSMtower_standard_model_Matching;
...
template<>
class NMSSMtower_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   NMSSMtower_standard_model_Matching();

   NMSSMtower_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       NMSSMtower<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~NMSSMtower_standard_model_Matching();
